...
#define LOG_TAG "android.hardware.power-service.xiaomi_msm8937-libperfmgr"
...
int main() {
    ...
    LOG(INFO) << "Xiaomi MSM8937 Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "Xiaomi MSM8937 Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
